...
public class CustomChat extends Module {
    ...
    public String suffix = " <-- don't listen to this message, i'm actually a retard";
                ...
                for (PlayerEntity e : mc.world.getPlayers()) {
                    ...
                    if (mc.player.distanceTo(e) < 12 && msg.contains(e.getName().asString())
                        ...
                        if (getSetting(4).asMode().mode == 1) {
                            mc.player.sendChatMessage(e.getName().asString() + " Just got EZed By ApeHack " + BleachHack.VERSION);
                        } else {
                            mc.player.sendChatMessage("GG, " + e.getName().asString() + ", but ApeHack " + BleachHack.VERSION + " is ontop!");
                        }
                    }
                }
            }
